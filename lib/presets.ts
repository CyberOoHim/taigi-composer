...
export const PRESET_SONGS: Song[] = [
    ...
    measures: [
      ...
      },
      {
        ...
        notes: [
          ...
          { id: 'n32', pitch: 2, octave: 0, duration: 1, lyric: { hanji: '開', poj: 'khui', pij: 'khui', custom: '開' } },
        ],
      },
      {
        id: 'm8',
  ...
  },
  {
    ...
    subtitle: 'Taiwanese Traditional (鄧雨賢 曲 / 周添旺 詞)',
    composer: '鄧雨賢 (Tēng Ú-hiân)',
    ...
    bpm: 72,
    notesPerLine: 4,
    description: 'Poignant traditional song about wind, rain and flowers. Beautiful Taiwanese 5-tone pentatonic melody.',
    measures: [
      {
        id: 'u_m1',
        measureNumber: 1,
        ...
        section: 'Verse 1',
        notes: [
          { id: 'u_n1', pitch: 6, octave: 0, duration: 1, lyric: { hanji: '雨', poj: 'Hō͘', pij: 'Hōo', custom: '雨' } },
          { id: 'u_n2', pitch: 6, octave: 0, duration: 1, lyric: { hanji: '夜', poj: 'iā', pij: 'iā', custom: '夜' } },
          { id: 'u_n3', pitch: 5, octave: 0, duration: 1.5, isDotted: true, lyric: { hanji: '花', poj: 'hoe', pij: 'hue', custom: '花' } },
          { id: 'u_n4', pitch: 6, octave: 0, duration: 0.5, lyric: { hanji: '，', poj: '', pij: '', custom: '' } },
        ],
      },
      {
        id: 'u_m2',
        ...
        chord: 'Em',
        notes: [
          { id: 'u_n5', pitch: 3, octave: 0, duration: 1, lyric: { hanji: '雨', poj: 'hō͘', pij: 'hōo', custom: '雨' } },
          { id: 'u_n6', pitch: 2, octave: 0, duration: 1, lyric: { hanji: '夜', poj: 'iā', pij: 'iā', custom: '夜' } },
          { id: 'u_n7', pitch: 1, octave: 0, duration: 2, lyric: { hanji: '花', poj: 'hoe', pij: 'hue', custom: '花' } },
        ],
      },
      {
        id: 'u_m3',
        ...
        chord: 'C',
        notes: [
          { id: 'u_n8', pitch: 2, octave: 0, duration: 1, lyric: { hanji: '受', poj: 'siū', pij: 'siū', custom: '受' } },
          { id: 'u_n9', pitch: 3, octave: 0, duration: 1, lyric: { hanji: '風', poj: 'hong', pij: 'hong', custom: '風' } },
          { id: 'u_n10', pitch: 2, octave: 0, duration: 0.5, lyric: { hanji: '雨', poj: 'hō͘', pij: 'hōo', custom: '雨' } },
          { id: 'u_n11', pitch: 1, octave: 0, duration: 0.5, lyric: { hanji: '吹', poj: 'chhoe', pij: 'tshue', custom: '吹' } },
          { id: 'u_n12', pitch: 6, octave: -1, duration: 1, lyric: { hanji: '落', poj: 'lo̍h', pij: 'lo̍h', custom: '落' } },
        ],
      },
      {
        id: 'u_m4',
        ...
        chord: 'D7',
        notes: [
          { id: 'u_n13', pitch: 5, octave: -1, duration: 3, isDotted: true, lyric: { hanji: '地', poj: 'tē', pij: 'tē', custom: '地' } },
          { id: 'u_n14', pitch: 0, octave: 0, duration: 1, lyric: { hanji: '', poj: '', pij: '', custom: '' } },
        ],
      },
      {
        id: 'u_m5',
        ...
        section: 'Verse 2',
        notes: [
          { id: 'u_n15', pitch: 6, octave: 0, duration: 1, lyric: { hanji: '無', poj: 'Bô', pij: 'Bô', custom: '無' } },
          { id: 'u_n16', pitch: 6, octave: 0, duration: 1, lyric: { hanji: '人', poj: 'lâng', pij: 'lâng', custom: '人' } },
          { id: 'u_n17', pitch: 5, octave: 0, duration: 1.5, isDotted: true, lyric: { hanji: '看', poj: 'khòaⁿ', pij: 'khuànn', custom: '看' } },
          { id: 'u_n18', pitch: 6, octave: 0, duration: 0.5, lyric: { hanji: '見', poj: 'kìⁿ', pij: 'kìnn', custom: '見' } },
        ],
      },
      {
        id: 'u_m6',
        ...
        chord: 'Em',
        notes: [
          { id: 'u_n19', pitch: 3, octave: 0, duration: 1, lyric: { hanji: '日', poj: 'ji̍t', pij: 'ji̍t', custom: '日' } },
          { id: 'u_n20', pitch: 5, octave: 0, duration: 1, lyric: { hanji: '夜', poj: 'iā', pij: 'iā', custom: '夜' } },
          { id: 'u_n21', pitch: 6, octave: 0, duration: 2, lyric: { hanji: '怨', poj: 'oàn', pij: 'uàn', custom: '怨' } },
        ],
      },
      {
        id: 'u_m7',
        ...
        chord: 'C',
        notes: [
          { id: 'u_n22', pitch: 5, octave: 0, duration: 1, lyric: { hanji: '花', poj: 'hoe', pij: 'hue', custom: '花' } },
          { id: 'u_n23', pitch: 3, octave: 0, duration: 1, lyric: { hanji: '謝', poj: 'siā', pij: 'siā', custom: '謝' } },
          { id: 'u_n24', pitch: 2, octave: 0, duration: 0.5, lyric: { hanji: '落', poj: 'lo̍h', pij: 'lo̍h', custom: '落' } },
          { id: 'u_n25', pitch: 1, octave: 0, duration: 0.5, lyric: { hanji: '土', poj: 'thô͘', pij: 'thôo', custom: '土' } },
          { id: 'u_n26', pitch: 2, octave: 0, duration: 1, lyric: { hanji: '不', poj: 'put', pij: 'put', custom: '不' } },
        ],
      },
      {
        id: 'u_m8',
        ...
        chord: 'G',
        notes: [
          { id: 'u_n27', pitch: 1, octave: 0, duration: 3, isDotted: true, lyric: { hanji: '再', poj: 'chài', pij: 'tsài', custom: '再' } },
          { id: 'u_n28', pitch: 1, octave: 0, duration: 1, lyric: { hanji: '開', poj: 'khui', pij: 'khui', custom: '開' } },
        ],
      },
    ],
  },
