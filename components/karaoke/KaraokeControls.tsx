      ...
      <div className="flex flex-wrap items-center justify-between gap-3 pt-1">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center justify-center w-12 h-12 rounded-2xl bg-gradient-to-tr from-amber-500 to-amber-400 hover:from-amber-400 hover:to-amber-300 text-zinc-950 font-bold shadow-lg shadow-amber-500/20 active:scale-95 transition-all cursor-pointer"
        ...
        <div id="ktv-transpose-controls" className="flex items-center bg-zinc-800/90 rounded-xl p-1 border border-zinc-700 text-xs">
          ...
          <button
            ...
            className="px-2 py-1 rounded-lg bg-zinc-700 hover:bg-zinc-600 font-bold text-zinc-200 transition-colors cursor-pointer"
            title="Key down (b)"
          >
            ♭
          </button>
          ...
          {transpose !== 0 && (
            <button
              ...
              className="ml-1 px-1.5 py-0.5 text-[10px] text-zinc-400 hover:text-white underline cursor-pointer"
            >
              Reset
            </button>
          )}
        ...
        <div id="ktv-instrument-control" className="flex items-center gap-1.5 bg-zinc-800/90 rounded-xl p-1 border border-zinc-700 text-xs">
          ...
          <select
            ...
            className="bg-zinc-900 text-zinc-200 font-medium px-2 py-1 rounded-lg border border-zinc-700 focus:outline-hidden focus:border-amber-400 cursor-pointer"
          >
